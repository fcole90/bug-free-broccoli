...
- If the target uses local agent workspaces, did you add `.agents/playground/` and `.agents/tasks/` to both Git ignore rules and the AI exclusion policy, unless the target explicitly chose a different convention?
